...
class SunkenShipPiece
{
	private static final ResourceLocation SUNKENSHIP = GeneralUtils.Location("sunkenship");
	...
	public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random)
	{
		...
		pieceList.add(new SunkenShipPiece.Piece(templateManager, SUNKENSHIP, blockpos, rotation));
	}
	...
	public static class Piece extends TemplateStructurePiece
	{
		...
		{
			super(DeepWatersStructureInit.SunkenShipPieceType, 0);
		...
		{
			super(DeepWatersStructureInit.SunkenShipPieceType, tagCompound);
