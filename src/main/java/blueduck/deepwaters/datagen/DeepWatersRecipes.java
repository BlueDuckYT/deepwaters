...
import blueduck.deepwaters.datagen.provider.DeepWatersRecipeProvider;
...
public class DeepWatersRecipes extends DeepWatersRecipeProvider
{
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> consumer)
	{
		...
		makeBricks(DeepWatersBlocks.CHISELED_PRISMARINE, () -> Blocks.PRISMARINE).build(consumer, "prismarine_chiseled");
