...
import blueduck.deepwaters.client.renderer.model.SkullFishModel;
...
//		}
	...
	@Override
	public void render(SkullFish entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
