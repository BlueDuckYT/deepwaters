...
public class DeepWatersItems
{
	...
	public static final RegistryObject<Item> PRISMARINE_BOOTS = ITEMS.register("primarine_boots", () -> new DeepWatersArmorItem(DeepWatersArmorMaterials.PRISMARINE, EquipmentSlotType.FEET));
