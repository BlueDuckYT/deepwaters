...
public class DeepWatersEntities
{
	...
	public static final RegistryObject<EntityType<CoralCrawler>> CORAL_CRAWLER = EntityUtils.BuildWaterEntity(CoralCrawler::new, CoralCrawler.class, .8F, 1.5F);
	public static final RegistryObject<EntityType<DonutFish>> DONUT_FISH = EntityUtils.BuildWaterEntity(DonutFish::new, DonutFish.class, .3F, .3F);
