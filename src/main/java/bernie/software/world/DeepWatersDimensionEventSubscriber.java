...
//		}
		...
		int totalLight = world.getLight(new BlockPos(vec.x, vec.y, vec.z)) + 15;
...
//					DeepWatersMod.logger.log(Level.INFO,"3:"+(double)(prevFogCount));
					prevFogCount = fogCount1;
				}
...
//			DeepWatersMod.logger.log(Level.INFO,"1:"+amt);
			double renderDensity = (MathHelper.lerp(amt, prevFogCount, fogCount1));
