...
public abstract class DeepWatersNoiseChunkGenerator<T extends GenerationSettings> extends ChunkGenerator<T>
{
	...
	public DeepWatersNoiseChunkGenerator(IWorld worldIn, BiomeProvider biomeProviderIn, int horizontalNoiseGranularityIn, int verticalNoiseGranularityIn, int p_i49931_5_, T settingsIn, boolean usePerlin) {
