...
public abstract class AbstractUnderwaterEntity extends WaterMobEntity
{
	public boolean IsSwimmingCreature;
	public boolean TakesKnockback;
	...
	public AbstractUnderwaterEntity(EntityType<? extends AbstractUnderwaterEntity> type, World worldIn, boolean swims, boolean takesKnockback) {
		super(type, worldIn);
		IsSwimmingCreature = swims;
		TakesKnockback = takesKnockback;
		this.moveController = new AbstractUnderwaterEntity.MoveHelperController(this);
	}
	...
	protected void registerGoals() {
		if(IsSwimmingCreature)
		{
			...
			this.goalSelector.addGoal(4, new AbstractUnderwaterEntity.SwimGoal(this));
		}
	}
	...
	static class MoveHelperController extends MovementController {
		...
		MoveHelperController(AbstractUnderwaterEntity fish) {
			super(fish);
			this.fish = fish;
		}

		public void tick() {
			if (fish.IsSwimmingCreature && this.fish.areEyesInFluid(FluidTags.WATER)) {
	...
	static class SwimGoal extends RandomSwimmingGoal
	{
		...
		public SwimGoal(AbstractUnderwaterEntity fish) {
			super(fish, 1.0D, 40);
			this.fish = fish;
		}
