...
public class KillerWiggler extends MonsterEntity
{
	...
	public class KillerWigglerAttackGoal extends MeleeAttackGoal
	{
		public KillerWigglerAttackGoal(CreatureEntity creature, double speedIn, boolean useLongMemory)
		{
