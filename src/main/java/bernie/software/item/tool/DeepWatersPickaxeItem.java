...
public class DeepWatersPickaxeItem extends PickaxeItem
{
	...
	public DeepWatersPickaxeItem(DeepWatersItemTiers tier)
	{
	...
	public Multimap<String, AttributeModifier> getAttributeModifiers(EquipmentSlotType slot, ItemStack stack) {
		if (slot == EquipmentSlotType.MAINHAND) {
			...
			if (material instanceof DeepWatersIngotItem) {
				...
				modifiers.put(SharedMonsterAttributes.ATTACK_SPEED.getName(), new AttributeModifier(ATTACK_SPEED_MODIFIER, "Tool modifier", (double) this.attackSpeed, AttributeModifier.Operation.ADDITION));
			}
			return modifiers;
		}
