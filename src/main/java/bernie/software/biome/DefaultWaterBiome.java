...
public class DefaultWaterBiome extends Biome
{
	public DefaultWaterBiome()
	{
		...
		this.addSpawn(EntityClassification.WATER_CREATURE, new Biome.SpawnListEntry(EntityType.COD, 20, 10, 15));
		this.addSpawn(EntityClassification.WATER_CREATURE, new Biome.SpawnListEntry(EntityType.SALMON, 10, 5, 10));
