...
@OnlyIn(Dist.CLIENT)
public class Colors implements IBlockColor {
    public int getColorAquastone(BlockState p_getColor_1_, @Nullable IEnviromentBlockReader p_getColor_2_, @Nullable BlockPos p_getColor_3_, int p_getColor_4_) {
        try
        {
